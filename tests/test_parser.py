"""A module for testing :mod:`cp2kparser.parser`."""

from cp2kparser.parser import (
    value_to_float, value_to_int, split_str, parse_multi_keys, read_input
)

FILENAME = 'tests/cp2k_job_opt.in'


def test_value_to_float() -> None:
    """Test :func:`cp2kparser.parser.value_to_float`."""
...
def test_value_to_int() -> None:
    """Test :func:`cp2kparser.parser.value_to_int`."""
...
def test_split_item() -> None:
    """Test :func:`cp2kparser.parser.split_str`."""
    assert ('a', '') == split_str('A')
    assert ('a', 'B') == split_str('A B')
    assert ('a', 'B C') == split_str('A B C')


def test_parse_multi_keys() -> None:
    """Test :func:`cp2kparser.parser.parse_multi_keys`."""
...
def test_read_input() -> None:
    """Test :func:`cp2kparser.parser.read_input`."""
